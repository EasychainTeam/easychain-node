...
function main() {
  ...
  program
    ...
    .option('-d, --daemon', 'Run easychain node as daemon')
  ...
  var pidFile = path.join(baseDir, 'easychain.pid');
  if (fs.existsSync(pidFile)) {
    console.log('Failed: easychain server already started');
    return;
  }
  ...
  if (program.daemon) {
    console.log('easychain server started as daemon ...');
